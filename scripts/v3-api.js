...
!function () {
  ...
  function B(n, a) {
    ...
    A.getElementById("createloginBtnMain").innerText = "Loading...",
      A.getElementById("createloginBtnMain").className += " btnloading",
      A.getElementById("errorsubmit") && A.getElementById("errorsubmit").remove();
    var e, t, i, r, d = "", c = !1, l = [];
    return "login" != n && (A.getElementById("inputEmail1") && (d = A.getElementById("inputEmail1").value),
      (d.length < 2 || 30 < d.length) && (c = !0,
        l.push("Nickname must be between 2-30 characters"))),
      (e = A.getElementById("inputEmail2").value).length < 5 && (c = !0,
        l.push("Please enter a valid email address")),
      ((t = A.getElementById("inputEmail3").value).length < 6 || 30 < t.length) && (c = !0,
        l.push("Password must be between 6-30 characters")),
      c ? (A.getElementById("createloginBtnMain").innerText = o,
        A.getElementById("createloginBtnMain").classList.remove("btnloading"),
        A.getElementById("createloginBtnMain").disabled = !1,
        (r = document.createElement("div")).id = "errorsubmit",
        r.className = "error_msg",
        i = document.createTextNode(l[0]),
        r.appendChild(i),
        A.getElementById("signupFormWrap").insertBefore(r, A.getElementById("loginit"))) : ((i = new XMLHttpRequest).onreadystatechange = function () {
          var e, t;
          4 == this.readyState && 200 == this.status && (t = (t = this.responseText).replace(")]}',", ""),
            !0 === (t = JSON.parse(t)).success && 0 < t.uid ? (A.getElementById("createloginBtnMain").innerText = "Success!",
              A.getElementById("createloginBtnMain").className += " btnSuccessMsg",
              window.parent.showUserInfo(t),
              setTimeout(function () {
                A.getElementById("createloginBtnMain").className = "main_hs_btn viewranks btnSuccessMsg",
                  s(A.getElementById("leaderboard-modal")),
                  setTimeout(function () {
                    A.getElementById("leaderboard-wrapper").remove()
                  }, 200),
                  setTimeout(function () {
                    A.getElementById("leaderboard-modal").remove(),
                      a && LaggedAPI.Scores.load(m, n)
                  }, 300)
              }, 600)) : (A.getElementById("createloginBtnMain").innerText = o,
                A.getElementById("createloginBtnMain").className = "main_hs_btn viewranks",
                A.getElementById("createloginBtnMain").disabled = !1,
                (e = document.createElement("div")).id = "errorsubmit",
                e.className = "error_msg",
                t = document.createTextNode(t.errors),
                e.appendChild(t),
                A.getElementById("signupFormWrap").insertBefore(e, A.getElementById("loginit"))))
        }
          ,
          (r = {
            fnickname: null
          }).ftype = n,
          d && (r.fnickname = encodeURIComponent(d)),
          r.femail = encodeURIComponent(e),
          r.fpass = encodeURIComponent(t),
          i.open("POST", "//lagged.com/api/v3/ajax.php", !0),
          i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
          i.send("ftype=" + r.ftype + "&fnickname=" + r.fnickname + "&femail=" + r.femail + "&fpass=" + r.fpass)),
      !1
  }
  function s(e) {
    var t = 1;
  ...
  function N() {
    s(A.getElementById("leaderboard-loading")),
      setTimeout(function () {
        A.getElementById("leaderboard-loading").remove()
      }, 200)
  }
  function o(e) {
    l = window.parent.isFullscreen,
      A = l ? document : window.parent.document,
      ...
      base64: function (e) {
        ...
        for (e = function (e) {
          ...
          a = (r = e.charCodeAt(c++)) >> 2,
            o = (3 & r) << 4 | (t = e.charCodeAt(c++)) >> 4,
            i = (15 & t) << 2 | (n = e.charCodeAt(c++)) >> 6,
            r = 63 & n,
            isNaN(t) ? i = r = 64 : isNaN(n) && (r = 64),
            d = d + v.charAt(a) + v.charAt(o) + v.charAt(i) + v.charAt(r);
        return d
      },
      md5: function (e) {
  ...
  A ? u = !0 : (console.log("not on lagged, use event"),
    p = !0);
  try {
    ...
    LaggedAPI.Scores = {
      save: function (e, t) {
        ...
        if (p)
          ...
          u && r("highscore", "hs2_p1", "save", a, h, t)
      },
      load: function (e, t) {
        if (p)
          try {
  ...
  var g = function (e, t) {
    ...
    , h = function (e, t) {
      ...
      e && !0 === e.success ? (hsData = e,
        function () {
          ...
          n.onclick = function () {
            A.getElementById("leaderboard-wrapper") && A.getElementById("leaderboard-wrapper").remove(),
              A.getElementById("leaderboard-modal") && (A.getElementById("leaderboard-modal").onclick = "",
                A.getElementById("leaderboard-modal").remove())
          }
            ,
            n.id = "leaderboard-header-button";
          var a = document.createElement("a");
          a.setAttribute("href", "https://lagged.com"),
          ...
          m.id = "score-circle",
            ...
            hsData.data && !hsData.data.login ? ((o = document.createElement("div")).className = "yourscore_txtdiv",
              ...
              o.appendChild(r),
              (d = document.createElement("div")).className = "finalscore_divtxt",
              c = document.createTextNode(k(hsData.data.utop.score)),
              d.appendChild(c),
              m.appendChild(o),
              m.appendChild(d),
              e.appendChild(m),
              ...
              ,
              l.className = "main_hs_btn viewranks",
              s = document.createTextNode("View Leaderboard"),
              l.appendChild(s),
              e.appendChild(t),
              e.appendChild(l)) : ((m = document.createElement("div")).id = "guestscorecircle",
                (o = document.createElement("div")).className = "yourscore_txtdiv",
                r = document.createTextNode("Your High Score"),
                o.appendChild(r),
                (d = document.createElement("div")).className = "finalscore_divtxt",
                c = document.createTextNode(k(hsData.data.topscore)),
                d.appendChild(c),
                m.appendChild(o),
                m.appendChild(d),
                e.appendChild(m),
                (l = document.createElement("button")).onclick = function () {
                  !function i(e) {
                    2 === e ? A.getElementById("achlistwrap").remove() : 1 === e ? (A.getElementById("guestscorecircle").remove(),
                      A.getElementsByClassName("signup_txti")[0].remove(),
                      A.getElementsByClassName("viewleaderguest")[0].remove(),
                      A.getElementsByClassName("moregames_wrapper")[0].remove(),
                      A.getElementsByClassName("main_hs_btn")[0].remove()) : A.getElementById("signupFormWrap").remove();
                    var t = document.createElement("div");
                    t.id = "signupFormWrap";
                    var r = 2 === e ? !1 : !0;
                      ...
                      o.onclick = function () {
                        !function () {
                          ...
                          o.setAttribute("form", "inputEmail2"),
                            ...
                            t.appendChild(a),
                            e.appendChild(t),
                            A.getElementById("leaderboard-wrapper").appendChild(e),
                            isMobile || A.getElementById("inputEmail2").focus()
                        }()
                      }
                      ,
                    ...
                    a.appendChild(n),
                      e.appendChild(a),
                      t.appendChild(e),
                      A.getElementById("leaderboard-wrapper").appendChild(t),
                      isMobile || A.getElementById("inputEmail1").focus()
                  }(1)
                }
                ,
                l.className = "main_hs_btn guestsubmitmainhs",
    ...
    , y = function (e, t) {
      ...
      setTimeout(function () {
        A.getElementsByClassName(n)[0] && (s(A.getElementsByClassName(n)[0]),
          v--,
          setTimeout(function () {
